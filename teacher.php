 ...
 <body>
   <!-- Fixed navbar -->
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<img src="iitlogo.jpg" alt="Welcome to IIT" width="70" height="70" >
    <h2><a class="navbar-brand" href="index.php" style="font-size:28px;">Islamiah Institute of Technology</a></h2>
  ...
  <br><br><div class="container">
    <?php
      ...
      echo '<br><br><br><h2>Welcome , '.$name.'.</h2>';
      ...
      if(!$classes) {
        ...
        foreach($classes as $class_id) {
          ...
          echo '<div class="class">
            ...
            <div><strong>Current Year</strong> : <span class="section">'.$section.'</span></div>
            <div><strong>Academic</strong> : <span class="year">'.$year.'</span></div>
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : CSE-051">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 001/CS/17)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 019/CS/17)">
